...
function InputForm() {
    ...
    const data = useSelector(state => state.simpleForm)
    ...
    const handleSubmit=(e)=>{
        ...
        dispatch(addData({id:uuidv4(),username:username,email:email,phone:phone,dob:dob,district:district,city:city,provience:provience,country:country}));
        setToInitial();
        setErrToInitial();
       }
